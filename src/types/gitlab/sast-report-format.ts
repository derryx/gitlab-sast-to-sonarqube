...
export interface ReportFormatForGitLabSAST {
  scan: {
    ...
    options?: {
       ...
       */
      source?: "argument" | "file" | "env_variable" | "other";
      /**
  ...
  vulnerabilities: {
    ...
    /**
     * An ordered array of CVSS vectors, each issued by a vendor to rate the vulnerability. The first item in the array is used as the primary CVSS vector, and is used to filter and sort the vulnerability.
     *
     * @minItems 1
     * @maxItems 10
     */
